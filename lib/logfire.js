...
/**
 * Initializes the logger with the proper log level
 * @private
 */
Logfire.prototype._initLog = function() {
  var logLevel = (this.options.debug ? 'debug' : 'info');
  global.Log = new (require('./utils/log'))(logLevel);
};
